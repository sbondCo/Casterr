  ...
  public get Icon(): string {
    switch (this.i) {
      ...
      case "chevron":
        ...
        return `
          <path fill-rule="evenodd" clip-rule="evenodd" d="M1.7 0L.3 1.41 4.88 6 .3 10.59 1.7 12l6-6-6-6z"/>
        `;
      case "clips":
