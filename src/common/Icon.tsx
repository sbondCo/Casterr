...
function getIcon(name: string): { viewBox: string; el: JSX.Element } {
  switch (name) {
    ...
    case "pause":
      return {
        viewBox: "0 0 35 41",
        el: <path fillRule="evenodd" clipRule="evenodd" d="M0 41H11.6667V0H0V41ZM23.3333 0V41H35V0H23.3333Z" />
      };
    case "upload":
      return {
        viewBox: "0 0 16 18",
        el: <path fillRule="evenodd" clipRule="evenodd" d="M0 2V0H16V2H0ZM7 8H4L8 4L12 8H9V18H7V8Z" />
      };
    case "volumeMute":
      return {
        viewBox: "0 0 50 50",
    ...
    case "add":
      return {
        viewBox: "0 0 68 68",
        el: <path d="M68 38.857H38.857V68h-9.714V38.857H0v-9.714h29.143V0h9.714v29.143H68v9.714z" />
      };
    case "min2":
      return {
        viewBox: "0 0 12 12",
        el: <rect width="10" height="2" x="1" y="5"></rect>
      };
    case "min":
      return {
        viewBox: "0 0 12 12",
        el: <rect width="10" height="1" x="1" y="6"></rect>
      };
    case "max":
      return {
        viewBox: "0 0 12 12",
        el: <rect width="9" height="9" x="1.5" y="1.5" fill="none" stroke="currentColor"></rect>
      };
    case "close":
      return {
        viewBox: "0 0 12 12",
    ...
    case "chevron":
      return {
        viewBox: "0 0 8 12",
        el: <path fillRule="evenodd" clipRule="evenodd" d="M1.7 0L.3 1.41 4.88 6 .3 10.59 1.7 12l6-6-6-6z" />
      };
    case "clips":
      return {
        viewBox: "0 0 30 30",
